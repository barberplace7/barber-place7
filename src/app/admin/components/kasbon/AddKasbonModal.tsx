...
export default function AddKasbonModal({ onClose, onSubmit, isSubmitting, capsters, kasirList, cabangList }: AddKasbonModalProps) {
    ...
    <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-xl shadow-2xl max-w-md w-full">
        <div className="px-6 py-4 border-b border-gray-200">
          <h3 className="text-lg font-bold text-black">Tambah Kasbon Staff</h3>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="px-6 py-4 border-t border-gray-200 flex gap-3">
            ...
            >
              ...
              {isSubmitting ? 'Submitting...' : 'Tambah Kasbon'}
            </button>
          </div>
        </form>
      </div>
