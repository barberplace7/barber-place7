...
export default function TransactionsTab({ cabangList }: any) {
  ...
  const transactionSummary = data?.summary || { totalRevenue: 0, totalExpenses: 0, cashRevenue: 0, qrisRevenue: 0 };
          ...
          <table className="min-w-full divide-y divide-gray-200">
            <thead className="bg-gray-50">
              <tr>
                ...
                <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase">Service/Product</th>
